...
const epithet1 = "interesting";
const epithet2 = "in demand";

console.log(`Javascript is: ${epithet}, ${epithet1}, ${epithet2}!`);

// 3. Оголосіть змінну. Присвойте їй значення. Переприсвойте значення на виведіть у консоль.
